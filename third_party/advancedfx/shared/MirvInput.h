...
public:
	...
	double GetSmoothHalfTimeVec() const { return m_HalfTimeVec; }
	double GetSmoothHalfTimeAng() const { return m_HalfTimeAng; }
	double GetSmoothHalfTimeFov() const { return m_HalfTimeFov; }
	bool GetSmoothEnabled() const { return m_SmoothEnabled; }
	bool GetSmoothRotShortestPath() const { return m_RotShortestPath; }
	bool GetRotLocalSpace() const { return m_RotLocalSpace; }
