...
private:
	...
	static Afx::Math::Quaternion RSelector(CamPathValue const & value)
	{
		return value.R;
	}
	...
	CInterpolationMapView<CamPathValue, Afx::Math::Quaternion> m_RView;
	...
	CInterpolation<Afx::Math::Quaternion> * m_RInterp;
